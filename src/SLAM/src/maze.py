...
class Maze(object):
    ...
    def show_estimated_location(self, particles):
        ...
        for particle in particles:
            # print("Particle: ", particle.weight, particle.x, particle.y)
        ...
        # print("Particle[0]: ", particles[0].x)
        # print("Estimated: ", x_estimate, y_estimate)
        turtle.color('orange')
    ...
    def sensor_model(self, coordinates, sensor_limit, orientation = 0):
        ...
        # print("Sensor_limits: ", sensor_limit)
...
class Particle(object):
    ...
    def __init__(self, x, y, maze, heading = None, weight = 1.0, sensor_limit = None, noisy = False):
        ...
        if noisy:
            ...
            self.heading = self.add_noise(x = self.heading, std = np.pi * 2 * 0.3)
