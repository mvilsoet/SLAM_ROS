...
##############################################################################################################
        ...
        filter_fl = np.logical_and(abs(x_points)-abs(y_points)<0.1, abs(x_points)-abs(y_points)>-0.1)
        filter_fl = np.logical_and(filter_fl, y_points > 0)
        filter_fl = np.logical_and(filter_fl, x_points > 0)
        ...
        filter_rl = np.logical_and(abs(x_points)-abs(y_points)<0.1, abs(x_points)-abs(y_points)>-0.1)
        filter_rl = np.logical_and(filter_rl, y_points > 0)
        filter_rl = np.logical_and(filter_rl, x_points < 0)
        ...
        filter_fr = np.logical_and(abs(x_points)-abs(y_points)<0.1, abs(x_points)-abs(y_points)>-0.1)
        filter_fr = np.logical_and(filter_fr, y_points < 0)
        filter_fr = np.logical_and(filter_fr, x_points > 0)
        ...
        filter_rr = np.logical_and(abs(x_points)-abs(y_points)<0.1, abs(x_points)-abs(y_points)>-0.1)
        filter_rr = np.logical_and(filter_rr, y_points < 0)
        filter_rr = np.logical_and(filter_rr, x_points < 0)
